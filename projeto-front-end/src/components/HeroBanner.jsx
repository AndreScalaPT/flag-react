...
export default function HeroBanner() {
  return (
    ...
    >
      ...
      <div className="mb-[8vh] flex flex-col items-center space-y-[clamp(0.5rem,2vw,1.5rem)] px-6">
        ...
        <h1 className="font-extrabold tracking-[0.25em] text-[clamp(3rem,11vw,10rem)] leading-[0.9] text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]">
          CONTACTO
        </h1>
      </div>
    </section>
